...
.agent-cta{display:flex;gap:16px;align-items:center;flex-wrap:wrap;padding:14px 18px;background:var(--s1);border:1px solid rgba(139,92,246,.4);border-radius:10px;margin-bottom:26px;animation:agentCtaPulse 2.6s ease-in-out infinite}
...
@media (prefers-reduced-motion:reduce){.agent-cta{animation:none}}
